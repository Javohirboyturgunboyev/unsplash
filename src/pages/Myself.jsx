  ...
  return (
    <div>
      ...
      <p className="text-xl mt-3 ml-10 mr-10">Men o`zim dasturlashga juda ham qiziqaman. Men 2023-yil 27-noyabrda dasturlashga ilk qadamimni quydim.
         ...
         Men bu vatgacha turli xil qiyinchiliklarga uchradim lekin ularni yengib o`tdim. Men 8 oy ichida juda ham ko`p narsalarni o`rgandim. 
          ...
          <p className="text-xl mt-3 ml-10 mr-10">Bu sahifamda Navbar, Main, va Footer qisimlari bor.
